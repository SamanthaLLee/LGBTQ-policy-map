  ...
  return (
    <Layout home>
      ...
      <section>
        ...
        <p>
          I fetched all the data from <a href="https://legiscan.com/legiscan">LegiScan</a> via Python. After developing a list of keywords (including "queer," "same-sex," "transgender," etc.), I looped through each state and used the Search API to query bills that contained
      ...
      <section>
        ...
        <ul>
          ...
          <li>More keywords should be added to include like asexual people, intersex people, non-binary people, and people of other identities.</li>
          ...
          <li>The map is colored based on general legislative activity, but I'd like to add a scoring system to evaluate how much a state protects or harms LGBTQIA+ people.</li>
        </ul>
      </section>
